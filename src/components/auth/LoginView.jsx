  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!result || !result.success) {
        ...
        console.log('✅ LoginView: Login exitoso, esperando actualización de estado...');
        // Si es exitoso, el hook useAuth manejará el estado del usuario
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  disabled={loading}
                  className="focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 sm:text-sm border-gray-300 rounded-md py-2 border disabled:bg-gray-100"
